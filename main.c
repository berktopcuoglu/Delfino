 ...
 *
 * Mimari:
 *  - Üst seviye: Elektronik diferansiyel (Ackermann tabanli hiz daðitimi)
...
static void initSPI(void)
{
    ...
    SPI_setConfig(M1_SPI_BASE, DEVICE_LSPCLK_FREQ, SPI_PROT_POL0PHA0, SPI_MODE_MASTER, 1000000, 16);
    ...
    SPI_setConfig(M2_SPI_BASE, DEVICE_LSPCLK_FREQ, SPI_PROT_POL0PHA0, SPI_MODE_MASTER, 1000000, 16);
